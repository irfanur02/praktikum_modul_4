 ...
 * @author irfan
 */
public class Irfan07156_GUIRencanaMatkul extends JFrame {
    ...
    public Irfan07156_GUIRencanaMatkul(int index) {
        ...
        JLabel labelNamaMenu = new JLabel("Rencana Mata Kuliah");
        labelNamaMenu.setBounds(16, 10, 300, 50);
        labelNamaMenu.setFont(new Font("Times New Roman", Font.BOLD, 20));
        add(labelNamaMenu);

        JLabel labelJurusan = new JLabel("Jurusan " + Irfan07156_JurusanEntity.jurusan[Irfan07156_AllObjekController.mahasiswa.getDataMahasiswa(index).getIndex_jurusan()]);
